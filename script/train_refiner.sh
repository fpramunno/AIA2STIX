...
#SBATCH --job-name="train_visibility_refiner_bigger_mse"
#SBATCH --error=./logs/err/err_train_visibility_refiner_bigger_mse.log
#SBATCH --out=./logs/out/out_train_visibility_refiner_bigger_mse.log
#SBATCH --cpus-per-task=4
#SBATCH --mem=32G

# Refiner training parameters
config_file="/mnt/nas05/data01/francesco/AIA2STIX/training/configs/refiner_config_mse.yaml"
...
checkpoint_dir="/mnt/nas05/data01/francesco/AIA2STIX/training/checkpoints/refiner_very_very_small"
device="cuda"

# Weights & Biases configuration
use_wandb=true
wandb_project="aia2stix_refiner"
wandb_run_name="refiner_very_very_small_bigger_mse"
